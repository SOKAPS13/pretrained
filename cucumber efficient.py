...
train_dir = r'C:\Users\Abhishek\Downloads\cucumber\cucumber\train'
validation_dir = r'C:\Users\Abhishek\Downloads\cucumber\cucumber\valid'
test_dir = r'C:\Users\Abhishek\Downloads\cucumber\cucumber\test'
...
history_fine_tuning = model.fit(
    ...
    epochs=EPOCHS,
    validation_data=validation_generator,
    callbacks=[early_stopping, reduce_lr]) b

# Evaluate the model on the test data after fine-tuning
# Evaluate the model on the test data after fine-tuning
score = model.evaluate(test_generator)
print(f'Test loss: {score[0]} / Test accuracy: {score[1]}')g
